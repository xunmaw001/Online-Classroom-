	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
        ...
        <view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
			...
			<view v-if="queryIndex==2" class="search-form round">
				<text class="cuIcon-search"></text>
				<input v-model="searchForm.renjiaokecheng" type="text" placeholder="任教课程" ></input>
			</view>
			<view class="action">
	...
	export default {
		...
		methods: {
			...
			queryChange(e) {
				...
				this.searchForm.renjiaokecheng="";
			},
			//类别搜索
			...
			async upCallback(mescroll) {
				...
				if(this.searchForm.renjiaokecheng){
			...
			async search(){
				...
				let searchForm = {
					...
					searchForm['jiaoshixingming'] = '%' + this.searchForm.jiaoshixingming + '%'
																																								...
																																								if(this.searchForm.renjiaokecheng){
					searchForm['renjiaokecheng'] = '%' + this.searchForm.renjiaokecheng + '%'
				}	
