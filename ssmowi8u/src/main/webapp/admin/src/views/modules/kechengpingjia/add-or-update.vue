<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学准备" prop="jiaoxuezhunbei">
          <el-select v-model="ruleForm.jiaoxuezhunbei" placeholder="请选择教学准备">
            <el-option
                v-for="(item,index) in jiaoxuezhunbeiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学设计" prop="jiaoxuesheji">
          <el-select v-model="ruleForm.jiaoxuesheji" placeholder="请选择教学设计">
            <el-option
                v-for="(item,index) in jiaoxueshejiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="教学设计" prop="jiaoxuesheji">
	      <el-input v-model="ruleForm.jiaoxuesheji"
                placeholder="教学设计" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学效果" prop="jiaoxuexiaoguo">
          <el-select v-model="ruleForm.jiaoxuexiaoguo" placeholder="请选择教学效果">
            <el-option
...
export default {
  ...
  computed: {
    zongpingfen: {
      get: function () {
        return 0+parseFloat(this.ruleForm.jiaoxuezhunbei==""?0:this.ruleForm.jiaoxuezhunbei)+parseFloat(this.ruleForm.jiaoxuesheji==""?0:this.ruleForm.jiaoxuesheji)+parseFloat(this.ruleForm.jiaoxuefangfa==""?0:this.ruleForm.jiaoxuefangfa)+parseFloat(this.ruleForm.jiaoxuexiaoguo==""?0:this.ruleForm.jiaoxuexiaoguo) || 0
      }
    },
  },
  created() {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoxuezhunbei = true;
          ...
          if(o=='jiaoxuesheji'){
            this.ruleForm.jiaoxuesheji = obj[o];
	    this.ro.jiaoxuesheji = true;
            continue;
          }
          if(o=='jiaoxuefangfa'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.jiaoxuezhunbeiOptions = "10,15,20,25".split(',')
            this.jiaoxueshejiOptions = "10,15,20,25".split(',')
            this.jiaoxuefangfaOptions = "10,15,20,25".split(',')
            this.jiaoxuexiaoguoOptions = "10,15,20,25".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
